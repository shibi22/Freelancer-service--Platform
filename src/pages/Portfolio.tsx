...
const portfolioItems = [
  ...
  },
  {
    ...
    downloadUrl: 'https://drive.google.com/file/d/1qIK-SmHxOTmmSYZdQ819NfYVSneEtfyA/view?usp=sharing',
    buttonType: 'download'
  },
  {
    title: 'Zomato Clone',
  ...
  },
  {
    ...
    category: 'Web Development',
    image: 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?auto=format&fit=crop&q=80&w=800',
    description: 'A Basic template for dashboard',
    demoUrl: 'https://www.zomato.com',
    buttonType: 'demo'
  }
];
          ...
          {portfolioItems.map((item) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-[#116466] mt-2 mb-4">
                  {item.description}
                </p>
                {item.buttonType === 'demo' ? (
                  <a
                    ...
                    className="inline-block bg-[#116466] text-white px-6 py-2 rounded-lg font-semibold 
                  ...
                  <a
                    ...
                    className="inline-block bg-[#FFCB9A] text-[#2C3531] px-6 py-2 rounded-lg font-semibold 
